...
var config = {
  ...
  copyright: 'Copyright &copy; ' + new Date().getFullYear() + ' - <a href="http://diasbytes.com">DiASBytes BVBA</a>',
  ...
  home_meta: {
    title: 'Welcome to the DiASBytes Knowledge Base',
    description: 'Find useful info on how to use the DiASBytes software.'
  },
